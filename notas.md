...
## Qué hay aquí
Fase de validación del producto digital (concepto aprobado por Craven el 17-sep-2026).
...
- $0 de gasto hasta que Craven apruebe lo contrario (el único gasto autorizado del objetivo es el dominio ~$12/año).
- Nada publicado ni desplegado sin el OK de Craven donde aplique (repo GitHub a su nombre si quiere, o el que se decida).
- Sin testimonios ni cifras de ventas inventadas: los umbrales de la landing son criterios propuestos, no resultados.
- Todo en español; sin datos personales de Craven en ningún fichero.
